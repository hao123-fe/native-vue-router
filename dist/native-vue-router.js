...
var View = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"haoapp-root"},[_c('div',{ref:"pageStackRoot",staticClass:"page-stack"},_vm._l((this.$routeStack),function(item,index){return _c('div',{key:item.path + index,class:{'page-wrap': true, 'hidden': !item.valid, 'first': !index, 'goback': item.state === 'pop'}},[_c('div',{staticClass:"page-viewport"},[_c('router-view-item',{attrs:{"route":item}},[_vm._v(_vm._s(item.path + index))])],1)])}))])},staticRenderFns: [],
  name: 'router-view',
  components: {
...
NativeVueRouter.prototype.getPageCount = function getPageCount () {
    var this$1 = this;

  // 计算有效页面数
  var pageCount = 0;
  for(var i = 0; i < this.routeStack.length; i++) {
    if (this$1.routeStack[i].valid !== false && this$1.routeStack[i].state != 'pop') {
      pageCount++;
    }
  }
  return pageCount
  ...
  history.listen(function (route) {
    ...
    this$1.apps.forEach(function (app) {
      ...
      if (method === 'push') {
        ...
        while (this$1.routeStack[this$1.routeStack.length - 1].valid === false 
